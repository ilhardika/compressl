...
export function HeroSection() {
  return (
    <section
      id="feature"
      className="w-full py-12 md:py-32 bg-gradient-to-br from-blue-50 to-white"
    >
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center">
        ...
        <div className="w-full md:hidden mb-10 order-first">
          <div className="relative w-full h-80 mx-auto max-w-sm">
        ...
        <div className="md:w-1/2 mb-10 md:mb-0">
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-extrabold text-blue-600 tracking-tight mb-6">
